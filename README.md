...
SQLAlchemy script to build a db in sqlite with an interactive menu for edition from the CLI.
...
* **GitHub Discussions:** [Open a discussion](https://github.com/gutiluis/SQLAlchemy-bookstore/discussions)
